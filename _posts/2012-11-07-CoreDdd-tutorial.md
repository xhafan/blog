...
_This article is for legacy CoreDdd [version 1.7.1.1](https://www.nuget.org/packages/CoreDdd/1.1.7.1). There is a newer CoreDdd [version 3](https://www.nuget.org/packages/CoreDdd), with a [documentation](https://github.com/xhafan/coreddd/wiki) and [code samples](https://github.com/xhafan/coreddd-sample). Also this tutorial uses [London style TDD](https://softwareengineering.stackexchange.com/questions/123627/what-are-the-london-and-chicago-schools-of-tdd) which I used at the point of writing this article (~2012), but since then I switched to [Chicago style TDD](https://softwareengineering.stackexchange.com/questions/123627/what-are-the-london-and-chicago-schools-of-tdd), and now I consider the TDD code samples in this article a legacy code. Newer blog posts about CoreDdd are [here]({{ site.baseurl }}/tags.html#coreddd)._

...
Please note that for a message bus you need a choose a transport which would transfer the messages. For Rebus, the [transport](https://github.com/rebus-org/Rebus/wiki/Transport) options are [RabbitMQ](https://www.rabbitmq.com/) (cross platform), MSMQ (Windows and full .NET framework only) and [others](https://github.com/rebus-org/Rebus/wiki/Transport).
